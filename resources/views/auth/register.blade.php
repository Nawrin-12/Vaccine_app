    ...
    <div class="w-4/12 bg-white p-6 rounded-lg">
       <form action="{{ route('register') }}" method="post">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="medical_records" id="medical_records" placeholder ="Previous medical records (allergy, disease)"
            class="bg-gray-100 border-2 w-full p-4 rounded-lg  @error('medical_records')
            border-red-500 @enderror" value="{{ old('medical_records') }}">
